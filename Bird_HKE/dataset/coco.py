...
from nms.utils import oks_nms
from nms.utils import soft_oks_nms
...
class COCODataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.pixel_std = 200
        self.root = r'C:\Users\marca\Desktop\HRNet Pytorch\data\coco'
    ...
    def _load_coco_person_detection_results(self):
        all_boxes = None
        with open(os.path.join(self.root,'person_detection_results',self.bbox_file), 'r') as f:
